...
def draft(request):
    ...
    return render(request, 'draft/draftroom.html', {'players':fa_dict, 'rounds':range(num_rounds), 'teams':range(num_teams)})
...
def access(request, id):
    ...
    return render(request, 'draft/draftroom.html', {'players':fa_dict, 'rounds':range(rounds), 'teams':range(teams)})